...
public class RedissonConfig {
    ...
    @ConditionalOnProperty(prefix = "spring.redis.server", name = "pattern", havingValue = "single")
    Redisson redissonClient() throws IOException {
        //1、创建配置
     ...
     **/
    @Bean
    @ConditionalOnProperty(prefix = "spring.redis.server", name = "pattern", havingValue = "cluster")
